...
<body>
    ...
    <a id="save_to_image">
        <div class="bl-container">
                ...
                <tr class="top">
                    <td colspan="2">
                        <table>
                            <tr>
                                <td class="title">
                                    <img src="{{ asset('images/bill.png') }}" style="width: 100%; max-width: 500px"/>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <div  class="e67_557">Received on board vessel in apparent good condition.</div>
            <br><br>
            <span  class="e67_558">
                <hr class="longline">
            </span>
            <br>
            <span  class="e67_559">Vessel’s Checker or Authorized Representative</span>
        </div>
    </a>
</body>
