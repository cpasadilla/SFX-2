                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                        <tr class="table-row">
                                            ...
                                            <td class="align-middle">
                                                <a href={{ route('c.order', ['key' => $user->cID]) }}><i
                                                        class='fas fa-cart-plus' style="color:grey"></i></a>
                                            </td>
                                        </tr>
                                        <div class="modal fade" id="editCustomerModal{{ $user->cID }}" tabindex="-1"
                                            role="dialog" aria-labelledby="editCustomerModal{{ $user->cID }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                            ...
                                                            <div class="card-body">
                                                                <form method="POST" action="{{ route('c.edit') }}"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input id="fName" type="text"
                                                                                ...
                                                                                name="fName"
                                                                                value="{{ $user->user->fName }}" required
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input id="lName" type="text"
                                                                                ...
                                                                                name="lName"
                                                                                value="{{ $user->user->lName }}" required
                                                                    ...
                                                                    <form method="POST" action="{{ route('c.reset') }}">
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            <P>FOR PASSWORDS THAT WERE RESETED, THE DEFAULT WILL BE
                                                                                "Pass1234"</P>
                                                                    </form>
                                                        </div>
