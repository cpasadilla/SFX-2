...
<div class="container-fluid header_se">
  <a href="{{route('o.pick')}}" style="color:black; font-size:30px;"><i class="fa-solid fa-arrow-left-long fa-lg"></i></a>
  <br>
  <br>
  <div class="row">
  ...
  <div class="col-md-8">
    ...
    <form action={{route('o.ship')}} method="post" enctype="multipart/form-data">
      @csrf
            <div class="card">
                <br>
                <h4 class="pl-4"> ORDERS TO BE UPDATED</h4>
                
                <div class="card-body">
                  <div class="input-group mb-1">
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                           placeholder="{{ __('Name of Receiver (Complete Name)') }}" required autocomplete="name" autofocus>
                ...
                <div class="input-group mb-1">
                  <input type="text" name="num" class="form-control @error('num') is-invalid @enderror"
                         placeholder="{{ __('Contact Number') }}" required autocomplete="num" autofocus>
                  <div class="input-group-append">
                      <div class="input-group-text">
                ...
                <input type="hidden" name="key" id="key" value="parcelReceived">
